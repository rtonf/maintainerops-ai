...
- npm latest is still `0.1.4`; a future npm publish should carry the GitHub API and schema-validation hardening to CLI users.
...
- Prepare npm `0.1.5` when npm authentication and OTP are available.
